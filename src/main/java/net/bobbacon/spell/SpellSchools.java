...
public class SpellSchools {
    ...
    public static final SpellSchool Conjuration= registryHelper.register("conjuration", new SpellSchool(Style.EMPTY.withColor(Formatting.BLUE).withBold(true),0x6CD6E0));
