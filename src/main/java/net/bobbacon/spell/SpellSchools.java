...
public class SpellSchools {
    ...
    public static final SpellSchool FIRE= registryHelper.register("fire", new SpellSchool(Style.EMPTY.withColor(Formatting.DARK_RED).withBold(true)));
    ...
    public static final SpellSchool Wind= registryHelper.register("wind", new SpellSchool(Style.EMPTY.withColor(Formatting.GRAY).withBold(true)));
