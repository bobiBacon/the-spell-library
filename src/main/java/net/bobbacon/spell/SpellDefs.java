...
public class SpellDefs {
    ...
    public static final SpellDef<?> Example= Registry.register(SpellRegistry.SPELL_TYPES,new Identifier(TheSpellLibrary.MOD_ID,"example"),new SpellDef<>(new ExampleSpell(),20).setCooldown(60).useTinted2dSymbol(0x50FF50).setRarity(Rarity.EPIC));
    ...
    public static final SpellDef<?> FlameBlast= registryHelper.register("flame_blast",new SpellDef<>(new InstantDamageSpell(15,5, DamageTypes.IN_FIRE, ParticleTypes.FLAME),10)
    ...
    public static final SpellDef<?> FireWave= registryHelper.register("fire_wave",new SpellDef<>(new FireWaveSpell(8,70),40)
    ...
    public static final SpellDef<?> Blindness= registryHelper.register("blindness",new SpellDef<>(new EffectTargetingSpell(20,ParticleTypes.SQUID_INK,new StatusEffectInstance(StatusEffects.BLINDNESS,300,0)),40)
