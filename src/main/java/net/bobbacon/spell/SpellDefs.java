...
public class SpellDefs {
    ...
    public static final SpellDef<?> FireBoom= registryHelper.register("fire_boom",new SpellDef<>(new ProjectionSpell(10,ParticleTypes.FLAME,2,ModParticles.FIRE_PARTICLE),SpellSchools.FIRE,20).setCooldown(200).useTinted2dSymbol(new Identifier(TheSpellLibrary.MOD_ID,"item/spell/tintable_fire"),0xcc3300,0xe6b800).setSound(ModSounds.FIREBALL_CASTING,ModSounds.FIREBALL_RELEASING).setCastTime(10).setRarity(Rarity.COMMON));
